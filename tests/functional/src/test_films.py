...
class TestsFilmsApi:
    ...
    @pytest.mark.asyncio
    async def test_film_detailed(self, redis_client, es_client, film_data_prepare, make_get_request):
    ...
    @pytest.mark.asyncio
    async def test_film_list(self, redis_client, es_client, film_data_prepare, make_get_request):
    ...
    @pytest.mark.asyncio
    async def test_film_list_custom_pagination(self, redis_client, es_client, film_data_prepare, make_get_request):
    ...
    @pytest.mark.asyncio
    async def test_film_list_filter(self, redis_client, es_client, film_data_prepare, make_get_request):
